...
public class TgCommandStart extends TgCommand {
    ...
    String[] msg = {
            "Добро пожаловать!",
            "Я %s бот.",
            "Предоставляю возможность ананимно отслеживать открытые Телеграмм каналы и группы с фильтрацией по ключевым словам.",
            ...
            "Для \"прослушивания\" кналов/групп необходимо добавить их в нашу базу, а так-же задать ключи для фильтра.",
            ""
    };
